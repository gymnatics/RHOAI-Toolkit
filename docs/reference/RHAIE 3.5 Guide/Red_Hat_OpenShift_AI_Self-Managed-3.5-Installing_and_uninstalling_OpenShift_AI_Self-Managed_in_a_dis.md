# Red_Hat_OpenShift_AI_Self-Managed-3.5-Installing_and_uninstalling_OpenShift_AI_Self-Managed_in_a_disconnected_environment-en-US.pdf
...
### Red Hat OpenShift AI Self-Managed  3.5 Installing and uninstalling OpenShift AI Self-Managed in a disconnected environment
...
CHAPTER 3 DEPLOY OPENSHIFT AI IN A DISCONNECTED ENVIRONMENT 3.1. REQUIREMENTS FOR OPENSHIFT AI SELF-MANAGED 

3.1.1. Platform requirements 3.1.2. Component requirements 

3.2. MIRROR IMAGES TO A PRIVATE REGISTRY FOR A DISCONNECTED INSTALLATION 3.3. CONFIGURE CUSTOM NAMESPACES 3.4. INSTALL THE RED HAT OPENSHIFT AI OPERATOR 

3.4.1. Installing the Red Hat OpenShift AI Operator by using the CLI 3.4.2. Installing the Red Hat OpenShift AI Operator by using the web console 

3.5. INSTALL AND MANAGE RED HAT OPENSHIFT AI COMPONENTS 3.5.1. Installing Red Hat OpenShift AI components by using the CLI 

3.5.1.1. Configure OAuth proxy sidecar resources for KServe 3.5.2. Installing Red Hat OpenShift AI components by using the web console 3.5.3. Update the installation status of Red Hat OpenShift AI components by using the web console 3.5.4. View installed OpenShift AI components 
...
12 13 17 19 19 22 24 24 27 30 33 36 
...
45 45 46 47 48 49 49 51 

54 56 57 58 61 61 

62 63 63 63 64 65 66 66 67 
...
CHAPTER 9 VIEW LOGS AND AUDIT RECORDS 9.1. CONFIGURE THE OPENSHIFT AI OPERATOR LOGGER 9.2. VIEW AUDIT RECORDS 
...
### CHAPTER 3. DEPLOY OPENSHIFT AI IN A DISCONNECTED ENVIRONMENT
...
5. Complete any additional configuration required for the components you enabled. 

6. Configure user and administrator groups to provide user access to OpenShift AI. 

7. Provide your users with the URL for the OpenShift cluster on which you deployed OpenShift AI. 
...
Subscriptions * A subscription for Red Hat OpenShift AI Self-Managed is required. 
...
Internet access on the mirroring machine * Along with internet access, the following domains must be accessible to mirror images required for the OpenShift AI installation: 
...
Image mirroring * For disconnected environments, you must mirror all required images to your private registry before installing OpenShift AI. See the RHOAI disconnected installation guide for details. 
...
3.2. MIRROR IMAGES TO A PRIVATE REGISTRY FOR A DISCONNECTED INSTALLATION 
...
You have reviewed the component requirements and identified all operators you must mirror in addition to the Red Hat OpenShift AI Operator. See Requirements for OpenShift AI Self-Managed. 
...
The oc-mirror plugin v1 is deprecated. Red Hat recommends that you use the ocmirror plugin v2 for continued support and improvements. 
...
**10. Log in to your target OpenShift cluster using the OpenShift CLI as a user with the clusteradmin role. **
...
b. Click Operators → OperatorHub. The OperatorHub page opens. 
...
3.3. CONFIGURE CUSTOM NAMESPACES 
...
3.4. INSTALL THE RED HAT OPENSHIFT AI OPERATOR 
...
kind: OperatorGroup metadata:   name: rhods-operator   namespace: redhat-ods-operator 

apiVersion: operators.coreos.com/v1alpha1 kind: Subscription metadata:   name: rhods-operator   namespace: redhat-ods-operator spec:   name: rhods-operator *  channel: <channel> *  source: cs-redhat-operator-index   sourceNamespace: openshift-marketplace   startingCSV: rhods-operator.x.y.z 
...
3.5. INSTALL AND MANAGE RED HAT OPENSHIFT AI COMPONENTS 
...
3.5.1.1. Configure OAuth proxy sidecar resources for KServe 
...
Optional. Specifies the OAuth proxy sidecar configuration for KServe inference services. If 
...
**you omit the oauthProxy block entirely, all Operator default values are preserved. If the field is absent from older DataScienceCluster configurations, the Operator skips the override to **maintain backward compatibility. 
...
{     "image": "<operator-managed-image>",     "memoryRequest": "256Mi",     "memoryLimit": "512Mi",     "cpuRequest": "100m",     "cpuLimit": "200m" } 
...
On OpenShift 4.19, click Operators → Installed Operators. 
    ...
    trustyai:       managementState: Removed     workbenches:       managementState: Removed       workbenchNamespace: rhods-notebooks 
...
3.5.3. Update the installation status of Red Hat OpenShift AI components by using the web console 
...
3. In the OpenShift web console, go to the Installed Operators page. The navigation path depends on your OpenShift version: 
      ...
      managementState: Removed       registriesNamespace: rhoai-model-registries     ray:       managementState: Removed     trainer:       managementState: Removed     trainingoperator:       managementState: Removed     trustyai:       managementState: Removed     workbenches:       managementState: Removed       workbenchNamespace: rhods-notebooks 
...
3.5.4. View installed OpenShift AI components 
