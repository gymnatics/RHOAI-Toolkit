...
if [ -n "$SKLEARN_MODEL_NAME" ]; then
    ...
    SKLEARN_API_URL="https://${SKLEARN_MODEL_NAME}-${NAMESPACE}.${CLUSTER_DOMAIN}/v2/models/${SKLEARN_MODEL_NAME}/infer"
...
MINIO_ROUTE="https://minio-api-${NAMESPACE}.${CLUSTER_DOMAIN}"
